...
ZelzalVP_cmd = (
    "𓆩 [𝗧𝗲𝗽𝘁𝗵𝗼𝗻 𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀 - أوامــر الفـارات](t.me/Tepthon) 𓆪\n\n"
    ...
    "⪼ `.اضف كليشة الايدي` بالـرد ع الكليشـــة مـن القنـاة @tepthonklaesh\n\n\n"
    ...
    "⪼ `.جلب فار` + اسـم الفـار\n\n"
    "⪼ `.حذف فار` + اسـم الفـار\n\n"
    "⪼ `.رفع مطور` بالـرد ع الشخـص لرفعـــة مطـور تحكـم كامـل بالأوامــر\n\n"
    "⪼ `.حذف فار المطورين`\n\n"
    "⪼ `.الوقت` لـ عـرض قائمـة أوامــر تغييـر الوقت حسب دولتك\n\n"
    "\n𓆩 [𝗧𝗲𝗽𝘁𝗵𝗼𝗻 𝗩𝗮𝗿𝘀 - قنـاة الفـارات](t.me/Tepthone1) 𓆪"
)


ZelzalTZ_cmd = (
    "𓆩 [𝗧𝗲𝗽𝘁𝗵𝗼𝗻 𝗖𝗼𝗻𝗳𝗶𝗴 - أوامــر الوقت](t.me/Tepthon) 𓆪\n\n"
    ...
    "⪼ `.وقت امريكا` \n\n"
    "⪼ `.وقت المانيا` \n\n"
    "🛃 سيتـم اضـافة المزيـد من الدول قريبًــــا\n\n"
    "\n𓆩 [𝗧𝗲𝗽𝘁𝗵𝗼𝗻 𝗩𝗮𝗿𝘀 - قنـاة الفـارات](t.me/Tepthone1) 𓆪"
)
...
async def variable(event):
    ...
    vinfo = reply.text
    rep = await edit_or_reply(event, "**⎉╎جـاري اضـافة الفـار إلى بـوتك ...**")
    ...
    if input_str == "كليشة الفحص" or input_str == "كليشه الفحص":
        ...
        if gvarstatus("ALIVE_TEMPLATE") is None:
            ...
            await rep.edit("**⎉╎تم إضـافــة {} بنجـاح ☑️**\n**⎉╎الكليشـة المضـافه** \n {} \n\n**⎉╎الآن قـم بـ ارسـال الامـر ↶** `.فحص` **لـ التحقـق مـن الكليشـة . .**".format(input_str, vinfo))
        ...
        if Config.HEROKU_API_KEY is None:
            return await ed(event, "**⎉╎عـذراً .. عـزيـزي ⚠️**\n**⎉╎هـذا الفـار لا يعمـل الآن ✖️**\n**⎉╎سـوف يتم تحديثه لاحقًـا ع منصه ريندر 🔄**")
...
async def variable(event):
    ...
    if input_str == "كليشة الفحص" or input_str == "كليشه الفحص":
        ...
        await asyncio.sleep(1.5)
        if gvarstatus("ALIVE_TEMPLATE") is None:
        	return await rep.edit("**⎉╎عـذࢪاً عـزيـزي .. انت لـم تقـم بإضـافــة فـار {} اصـلاً...**".format(input_str))
...
async def custom_rep(event):
    ...
    if (input_str == "كليشة الحماية" or input_str == "كليشة الحمايه" or input_str == "كليشه الحماية" or input_str == "كليشه الحمايه"):
        ...
        if variable is None:
            await rep.edit("**⎉╎فـار صـورة الأوامــر غيـر موجـود ❌**\n**⎉╎لـ اضـافته بالـرد ع صـورة فقـط استخـدم الامـر : ↶**\n `.اضف صورة الاوامر` \n\n**⎉╎قنـاة السـورس : @Tepthon**")
        else:
            await rep.edit("**⎉╎الفـار {} موجـود ☑️**\n**⎉╎قيمـة الفـار : ↶**\n `{}` \n\n**⎉╎قنـاة السـورس : @Tepthon**".format(input_str, variable))
        ...
        variable = "TZ"
        if variable not in heroku_var:
            await rep.edit("**⎉╎فـار المنطقـــة الزمنيـــة غيـر موجـود ❌**\n**⎉╎لـ اضـافته فقـط استخـدم الامـر : ↶**\n `.وقت` واسـم الدولـة \n\n**⎉╎قنـاة السـورس : @Tepthon**")
        else:
            await rep.edit("**⎉╎الفـار {} موجـود ☑️**\n**⎉╎قيمـة الفـار : ↶**\n `{}` \n\n**⎉╎قنـاة السـورس : @Tepthon**".format(input_str, variable))
...
async def variable(event):
    ...
    rep = await edit_or_reply(event, "**⎉╎جـاري إعـداد المنطقـــة الزمنيـــة لـ تيبثـون 🌐...**")
    # All Rights Reserved for "Tepthon" "باقر"
    if input_str == "العراق" or input_str == "اليمن" or input_str == "سوريا" or input_str == "السعودية" or input_str == "لبنان" or input_str == "الاردن":
        ...
        if gvarstatus("TZ") is not None:
            await rep.edit("**⎉╎تم تغييـر المنطقـــة الزمنيـــة .. بنجـاح ☑️**\n**⎉╎المتغير : ↶**\n دولـة `{}` \n**⎉╎يتم الآن إعــادة تشغيـل بـوت تيبثـون يستغـرق الأمر 2-1 دقيقـة ⏰ ▬▭ ...**".format(input_str))
        else:
            await rep.edit("**⎉╎تم إضـافــة المنطقـــة الزمنيـــة .. بنجـاح ☑️**\n**⎉╎المضـاف إليـــة : ↶**\n دولـة `{}` \n**⎉╎يتم الآن إعــادة تشغيـل بـوت تيبثـون يستغـرق الأمر 2-1 دقيقـة ⏰ ▬▭ ...**".format(input_str))
        addgvar("TZ", viraq)
...
async def alive_Tepthon(event):
    ...
    if reply and reply.media:
        input_str = event.pattern_match.group(1)
        zedevent = await event.edit("**⎉╎ جـار رفع الـصورة الى أمر الفحص**")
        try:
            ...
            if response.status_code == 200 and response.json().get("success"):
                ...
                await zedevent.edit(f"**⎉╎ تم اضافة الصورة الى الفحص ✓ **")
            else:
...
async def Tepthon(event):
    ...
    if reply and reply.media:
        input_str = event.pattern_match.group(1)
        zedevent = await event.edit("**⎉╎ جـار رفع الـصورة الى أمر الحماية**")
        try:
            baqir = await event.client.download_media(reply)
            if baqir.endswith((".webp")):
                resize_image(zed)
            ...
            if response.status_code == 200 and response.json().get("success"):
                ...
                await zedevent.edit(f"**⎉╎ تم اضافة الصورة الى الحماية ✓ **")
            else:
                await zedevent.edit(f"**⎉╎ حدث خطأ في رفع الصورة: **\n`{response.json()}`")
...
async def Tepthon(event):
    ...
    if reply and reply.media:
        input_str = event.pattern_match.group(1)
        zedevent = await event.edit("**⎉╎ جـار رفع الـصورة الى أمر لوحة الاوامر**")
        try:
            baqir = await event.client.download_media(reply)
            if baqir.endswith((".webp")):
                resize_image(zed)
            ...
            if response.status_code == 200 and response.json().get("success"):
                url = response.json()["files"][0]["url"]
                addgvar("CMD_PIC", url)
                await zedevent.edit(f"**⎉╎ تم اضافة الصورة الى لوحة الاوامر ✓ **")
            else:
                await zedevent.edit(f"**⎉╎ حدث خطأ في رفع الصورة: **\n`{response.json()}`")
...
async def Tepthon(event):
    ...
    if reply and reply.media:
        input_str = event.pattern_match.group(1)
        zedevent = await event.edit("**⎉╎ جـار رفع الـصورة الى أمر البوت**")
        try:
            baqir = await event.client.download_media(reply)
            if baqir.endswith((".webp")):
                resize_image(zed)
            ...
            if response.status_code == 200 and response.json().get("success"):
                ...
                await zedevent.edit(f"**⎉╎ تم اضافة الصورة الى البوت ✓ **")
            else:
                await zedevent.edit(f"**⎉╎ حدث خطأ في رفع الصورة: **\n`{response.json()}`")
...
async def Tepthon(event):
    ...
    if reply and reply.media:
        input_str = event.pattern_match.group(1)
        zedevent = await event.edit("**⎉╎ جـار رفع الـصورة الى أمر الصورة الوقتية**")
        try:
            baqir = await event.client.download_media(reply)
            if baqir.endswith((".webp")):
                resize_image(zed)
            ...
            if response.status_code == 200 and response.json().get("success"):
                ...
                await zedevent.edit(f"**⎉╎ تم اضافة الصورة إلى أمر الصورة الوقتية ✓ **")
            else:
                await zedevent.edit(f"**⎉╎ حدث خطأ في رفع الصورة: **\n`{response.json()}`")
...
async def cmd(zed):
    await edit_or_reply(baqir, ZelzalVP_cmd)
...
async def cmd(zed):
    await edit_or_reply(baqir, ZelzalTZ_cmd)
